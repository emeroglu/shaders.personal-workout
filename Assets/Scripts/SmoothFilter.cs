...
public class SmoothFilter : MonoBehaviour
{
    ...
    [Range(0, 1)]
    public float Coefficient = 0.125f;
    ...
    private void Start()
    {
        ...
        shader = Resources.Load<ComputeShader>("Shaders/SmoothFilterShader");
		...
		shader.SetInt("sigma", Sigma);
        shader.SetFloat("coef", Coefficient);
